...
export class GenerationService {
  ...
  generateImageToVideo(payload: { imageUrl: string; endImageUrl?: string; modelId: string; prompt?: string; durationSeconds?: number; resolution?: string; multiShot?: boolean; generateAudio?: boolean; aspectRatio?: string; isPublic?: boolean; zone?: string; negativePrompt?: string; cfgScale?: number; multiPrompts?: string[]; elements?: { imageUrl?: string; referenceImages?: string[]; videoUrl?: string }[]; promptOptimizer?: boolean; seed?: number; autoFix?: boolean }) {
