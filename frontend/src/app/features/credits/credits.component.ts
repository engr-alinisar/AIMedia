  ...
  <div>
    ...
    <div class="grid grid-cols-3 gap-3 sm:gap-4">
      @for (pack of packs; track pack.name) {
        <div class="card p-3 sm:p-5 text-center hover:border-accent/50 hover:shadow-md transition-all cursor-pointer" [class.border-accent]="pack.popular">
          @if (pack.popular) {
          ...
          <button class="btn-primary w-full mt-3 text-xs sm:text-sm py-1.5 sm:py-2">Buy Now</button>
        </div>
      }
    </div>
